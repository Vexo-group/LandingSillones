  ...
  return (
    <section ref={containerRef} className="py-20 lg:py-32 overflow-hidden">
        ...
        <Reveal>
          <div className="container-custom text-center">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Explore nuestras colecciones seleccionadas, cada una contando una historia única de artesanía y filosofía de diseño.
            </p>
          </div>
        </Reveal>
      </div>
      ...
      <div className="text-center mt-8">
        <p className="text-sm text-neutral-500">← Arrastre para explorar colecciones →</p>
      </div>
    </section>
  )
}
