            ...
            <BlurPanel className="p-8 lg:p-12 bg-white/40 backdrop-blur-md grain-texture">
              <div className="text-center mb-8">
                <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                  <AnimatedText text="No te pierdas " delay={0.2} />
                  <span className="italic font-light">
                    <AnimatedText text="de nada." delay={0.5} />
                  </span>
                </h2>
                <p className="text-lg text-neutral-600">
                  Se el primero en descubrir nuevas colecciones, ideas de diseño y acceso exclusivo a piezas limitadas.
                </p>
              </div>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {!isValid && (
                    ...
                    >
                      Por favor, introduce una dirección de correo electrónico válida aqui
                    </motion.p>
                  )}
                ...
                >
                  ...
                  <p className="text-neutral-600">
                    Gracias por suscribirse. Recibiras nuestras próximas noticias 
                    con información exclusiva y novedades.
                  </p>
                </motion.div>
              )}

              <p className="text-xs text-neutral-500 text-center mt-6">
                Respetamos tu privacidad. Cancela tu suscripción en cualquier momento. Lee nuestra{" "}
