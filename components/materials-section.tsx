...
const materials = [
  {
    ...
    description: "Lujoso terciopelo verde pistacho con hermosa textura y profundidad.",
  ...
  },
  {
    ...
    description: "Gris lunar sofisticado con sutiles matices metálicos.",
  ...
  },
  {
    ...
    description: "Rojo intenso con cálidas influencias terracota",
          ...
          <Reveal>
            <div>
              ...
              <p className="text-lg text-white/90 leading-relaxed max-w-2xl">
                Cada pieza se fabrica con los mejores materiales, cuidadosamente seleccionados por su belleza, durabilidad y origen sostenible. 
                Nuestros artesanos respetan las técnicas tradicionales y adoptan la precisión moderna.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.3}>
          <blockquote className="pl-0 py-4">
            <p className="text-xl text-white leading-relaxed italic lg:text-base font-medium">
              Creemos en crear muebles que trasciendan las tendencias: piezas que se embellecen con el tiempo, 
              transmitiendo historias y recuerdos a través de las generaciones.
            </p>
            <footer className="mt-4 text-sm text-white/70">— Vexo Studio</footer>
          </blockquote>
        </Reveal>
      </div>
