...
const featuredProducts = [
  {
    ...
    badge: "New" as const,
    materials: ["Marco de Cobre", "Terciopelo Premium"],
    swatches: [
  ...
  },
  {
    ...
    badge: "New" as const,
    materials: ["Marco de Cobre", "Terciopelo Terracota"],
    swatches: [
  ...
  },
  {
    ...
    materials: ["Marco de Cobre", "Terciopelo Verde Salvia"],
    swatches: [
      { name: "Sage Green", color: "#9CAF88" },
      { name: "Forest Green", color: "#355E3B" },
      { name: "Copper", color: "#B87333" },
        ...
        <Reveal>
          <div className="text-left mb-16">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl">
              Descubra nuestras piezas más queridas, cada una elaborada con meticulosa atención al detalle 
