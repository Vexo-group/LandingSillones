        ...
        <div className="container-custom text-center text-white">
          <Reveal>
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold leading-none tracking-tight mb-6">
              <AnimatedText text="Diseñamos para vos" delay={0.5} />
              <br />
              <span className="italic font-light">
                <AnimatedText text="mas que un sillon." delay={1.1} />
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              Donde el diseño se encuentra con la comodidad para transformar tu hogar.
            </motion.p>
          </Reveal>
        </div>
      </motion.div>
        ...
        <BlurPanel className="mx-6 mb-6 px-6 py-4 bg-black/24 backdrop-blur-md border-white/20">
          <div className="flex items-center justify-center gap-6 text-white/90">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Cuotas fijas</span>
            </div>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-blue-400" />
              <span className="text-sm">Garantia incluida</span>
            </div>
          </div>
        </BlurPanel>
      </motion.div>
